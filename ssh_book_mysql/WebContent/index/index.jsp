...
<div class="center_content">
	...
	<div class="left_content">
		...
		<!-- 精品推荐 -->
		<div class="title"><span class="title_icon"><img src="images/bullet1.gif"/></span>名医介绍</div>
			...
			<div class="feat_prod_box">
				...
				<div class="prod_det_box">
					...
					<div class="box_center">
						...
						<a href="detail.action?bookid=${id}" class="more">- 详细介绍 -</a>
						<div class="clear"></div>
					</div>
		...
		<!-- 最新出版 -->
		<div class="title"><span class="title_icon"><img src="images/bullet2.gif"/></span>最新医学成果</div>
