...
<table width="100%" border="1" cellpadding="1" cellspacing="1" class="yrh">
  <tr>
    <td height="10"><font size="4">科室信息列表</font></td>
  </tr>
</table>
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="inputTable">
    ...
    <tr>
     ...
     <td width="5%" align="center" class="inputHeader">编号</td>
            <td width="13%" align="center" class="inputHeader">科室名称</td>
        ...
        <tr>
         <td width="5%" align="center" class="inputHeader">${num}</td>
            ...
            <td width="12%" align="center" class="inputContent"><p>&nbsp;&nbsp;<a href="OfficeAction?method=deleteOffice&id=${list.id}" onClick="window.confirm('确定删除？')"><img src="picture/delete_item.gif" alt="删除" width="45" height="17" border="0"></a></p></td>
    ...
    <tr>
      <td class="inputTitle"><font size="3" color="#CC0000">&nbsp;&nbsp;添加科室信息</font></td>
    </tr>
    <tr>
      <td>
      <form action="OfficeAction?method=addOffice" method="post" name="form1"  onSubmit="return teamform()">
        <table width="100%" border="0" cellpadding="1" cellspacing="1" class="inputbox">
          <tr>
            <td width="4%" class="inputHeader">&nbsp;</td>
            <td width="11%" class="inputHeader">科室名称：</td>
